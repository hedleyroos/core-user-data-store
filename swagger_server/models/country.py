...
class Country(Model):
    ...
    def __init__(self, code: str=None, name: str=None, created_at: datetime=None, updated_at: datetime=None):  # noqa: E501
    ...
    def code(self, code: str):
        ...
        if code is not None and len(code) < 2:
            raise ValueError("Invalid value for `code`, length must be greater than or equal to `2`")  # noqa: E501
